...
class Localization extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'en_US': {
          ...
          'splash_1_phrase': 'Unlock the power of precise stock tracking. Master your entries and exits with confidence.',
          'splash_2_title': 'Streamline your business processes',
          'splash_2_phrase': 'Effortlessly manage purchase orders and invoices for seamless operations.',
          'splash_3_title': 'Empower Your Stock Management Journey',
          'splash_3_phrase': 'Seamlessly visualize and analyze your stock data, enabling you to make informed decisions and take your business to greater heights.',
          'skip': 'SKIP',
          'next': 'NEXT',
          'finish': 'FINISH',
        ...
        'fr_FR': {
          ...
          'stockify': 'Stockify',
          'login_with_email': 'Connectez-vous à votre compte en utilisant votre e-mail',
          'email': 'Email',
          ...
          'splash_1_phrase': 'Déverrouillez la puissance d\'un suivi précis des stocks. Maîtrisez vos entrées et sorties en toute confiance.',
          'splash_2_title': 'Optimisez vos processus métier',
          'splash_2_phrase': 'Gérez facilement les bons de commande et les factures pour des opérations fluides.',
          'splash_3_title': 'Donnez de l\'élan à votre gestion de stock',
          'splash_3_phrase': 'Visualisez et analysez facilement vos données de stock, vous permettant de prendre des décisions éclairées et d\'emmener votre entreprise vers de nouveaux sommets.',
          'skip': 'PASSER',
          'next': 'SUIVANT',
          'finish': 'TERMINER',
        ...
        'ar_MA': {
          ...
          'stockify': 'ستوكيفاي',
          'login_with_email': 'تسجيل الدخول إلى حسابك باستخدام البريد الإلكتروني',
          ...
          'splash_1_phrase': 'فتح قوة تتبع المخزون الدقيق. تقنين إجراءات الدخول والخروج بثقة.',
          'splash_2_title': 'جعل عمليات الأعمال أكثر سلاسة',
          'splash_2_phrase': 'إدارة طلبات الشراء والفواتير بسهولة لتحقيق التشغيل المتسق.',
          'splash_3_title': 'منح طاقم إدارة المخزون تمكينًا أكبر',
          'splash_3_phrase': 'تصور وتحليل بيانات المخزون بسلاسة، مما يمكّنك من اتخاذ قرارات مدروسة والارتقاء بأعمالك إلى آفاق أكبر.',
          'skip': 'تخطى',
          'next': 'التالي',
          'finish': 'إنهاء',
