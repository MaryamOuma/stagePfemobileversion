...
class ExitsInvoicesToValidate extends GetView<NotificationController> {
      ...
      body: Obx(
        () {
          ...
          return ListView.builder(
            itemCount: data.exitsinvoicesTovalidate?.length,
            itemBuilder: (context, index) {
              ExitInvoice invoice = data.exitsinvoicesTovalidate![index];
