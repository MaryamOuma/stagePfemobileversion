...
class ExitsInvoicesToPay extends GetView<NotificationController> {
      ...
      body: Obx(
        () {
          ...
          return ListView.builder(
            itemCount: data.exitsinvoicesTopay?.length,
            itemBuilder: (context, index) {
              ExitInvoice invoice = data.exitsinvoicesTopay![index];
