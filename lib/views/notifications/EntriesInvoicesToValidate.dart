...
class EntriesInvoicesToValidate extends GetView<NotificationController> {
      ...
      body: Obx(
        () {
          ...
          return ListView.builder(
            itemCount: data.entriesinvoicesTovalidate?.length,
            itemBuilder: (context, index) {
              Invoice invoice = data.entriesinvoicesTovalidate![index];
