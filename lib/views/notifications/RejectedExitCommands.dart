...
class RejectedExitCommands extends GetView<NotificationController> {
            ...
            child: Obx(
              () {
                ...
                return ListView.builder(
                  ...
                  itemCount: data.rejectedclientscommands?.length ?? 0,
                  itemBuilder: (context, index) {
                    final command = data.rejectedclientscommands![index];
