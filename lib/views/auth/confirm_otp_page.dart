...
class ConfirmOtpPage extends StatefulWidget {
  ...
  ConfirmOtpPage({required this.email});
...
class _ConfirmOtpPageState extends State<ConfirmOtpPage> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget verifyButton = Center(
      child: InkWell(
        onTap: () {
          String otpCode = otpController.text; // Extract the OTP code entered by the user from the PinCodeTextField
          authController.verifyOTP(widget.email, otpCode);
        },
        child: Container(
