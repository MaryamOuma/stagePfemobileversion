...
import 'package:flutter_project/controllers/LocalizationController.dart';
                  ...
                  children: languages
                      .map((l) => ListTile(
                            onTap: () {
                              ...
                              if (l == 'Arabic') {
                                localizationController.changeLanguage('ar', 'MA');
                              } else if (l == 'English') {
                                localizationController.changeLanguage('en', 'US');
                              } else if (l == 'French') {
                                localizationController.changeLanguage('fr', 'FR');
                              }
                            },
                            title: Text(
                              l,
