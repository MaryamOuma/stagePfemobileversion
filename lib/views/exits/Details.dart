...
class _DetailScreenState extends State<DetailScreen> {
  ...
  late ExitCommand command; // Add this line to hold the fetched command
  final ExitsController controller = Get.put(ExitsController());
  late Future<ExitCommand> _commandFuture;
  ExitCommand? _command;
          ...
          children: [
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            SizedBox(width: 5),
                            Text(
                              'Delivered To: ${_command?.clientEmail ?? ''}',
                              style: TextStyle(
                                color: Colors.black,
                                fontSize: 24,
                                fontWeight: FontWeight.normal,
            ...
            Row(
              children: [
                ...
                SizedBox(width: 5),
                Text(
                  '${_command?.comment ?? 'no comment has been written yet'}',
                  style: const TextStyle(
                    fontWeight: FontWeight.normal,
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: Column(
                  children: [
                    Expanded(
                      child: FutureBuilder<ExitCommand>(
