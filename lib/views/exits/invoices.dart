...
import '../../models/ExitInvoice.dart';

class ExitInvoices extends GetView<ExitInvoicesController> {
  final ExitInvoicesController controller = Get.put(ExitInvoicesController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: createExitsBottomNavigationBar(2),
      body: Obx(
        () {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ExitInvoice invoice = controller.invoices[index];
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Payed By:${widget.invoice.clientName} ${widget.invoice.clientEmail}',
                          style: TextStyle(
                            color: Colors.grey,
                            fontSize: 14,
                            fontWeight: FontWeight.bold,
